...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credentials = Credentials("karen","karen123","karen@gmail") 
...
#setup and other test cases up here
    def tearDown(self):
        """
 ...
 #other test cases here       
    ...
    def test_save_multiple_credentials(self):
        ...
        test_credentials = Credentials("user","user12345","user@gmail") # new credentials
    ...
    def  test_find_credentials_by_name(self):
        ...
        found_credentials = Credentials.find_by_name("user")
